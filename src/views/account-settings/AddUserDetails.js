    ...
    <CardContent>
      <form>
        <Grid container spacing={7}>
          ...
          <Grid item xs={12} sm={6}>
            <TextField fullWidth label='User Name' placeholder='User Name' onChange={handleChange('name')} />
          </Grid>
          <Grid
            item
            xs={12}
          ...
          <Grid item xs={12} sm={6}>
            <TextField fullWidth label='Email' placeholder='Email' onChange={handleChange('name')} />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField fullWidth label='Password' placeholder='Password' onChange={handleChange('name')} />
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <TextField fullWidth label='Phone Number' placeholder='Phone Number' onChange={handleChange('name')} />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField
              fullWidth
          ...
          <Grid item xs={12} sm={6}>
            <TextField fullWidth label='User Type' placeholder='User Type' onChange={handleChange('name')} />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField fullWidth label='Level' placeholder='Level' onChange={handleChange('name')} />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField
              fullWidth
