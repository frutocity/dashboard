...
import { BannerDataAtom, bannerModalAtom, categoryDataAtom, categoryModalAtom, detailsAtom, detailsCountAtom, exchangeDataAtom, exchangeModalAtom } from 'src/helpers/jotai/atom'
...
const AddCategory = () => {
  ...
  const update = () => {
    API.updateCategory({ body: values }, (d) => {
    ...
    <CardContent>
      <form>
        <Grid container spacing={7}>
          ...
          <Grid item xs={12} sm={6}>
            <TextField fullWidth label='Description' value={values.description} placeholder='' onChange={handleChange("description")} />
          </Grid>

          <Grid item xs={12} sm={6}>
            Active?
            <Switch checked={values.active} onChange={(e) => {
