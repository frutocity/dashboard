...
import { BannerDataAtom, bannerModalAtom, employeeDataAtom, employeeModalAtom, exchangeDataAtom, exchangeModalAtom, storeDataAtom, storeModalAtom } from 'src/helpers/jotai/atom'
...
const EmployeeTable = ({ list }) => {
  ...
  const [data, setData] = useAtom(employeeDataAtom)
