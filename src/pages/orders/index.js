...
import { employeeListAtom, orderListAtom, orderListPaginateAtom, roleListAtom, storeListAtom } from 'src/helpers/jotai/apiAtoms'
...
const MUITable = () => {
  const [list, setList] = useAtom(orderListAtom)
  const [opt, setOtp] = useAtom(orderListPaginateAtom)
